...
volatile bool triggerScan = false;    // Button-triggered scan flag
...
void loop()
{
  ...
  //     float dataTemp = 0;//currentSettings["temp-offset"];
  ...
  //     float datahumi =0; //currentSettings["humi-offset"];
  ...
  //     float dataPress = 0;//currentSettings["press-offset"];
  ...
  //     float datalux = 0;//currentSettings["Lux-offset"];
  ...
  //     float datauv =0; //currentSettings["UV-offset"];
